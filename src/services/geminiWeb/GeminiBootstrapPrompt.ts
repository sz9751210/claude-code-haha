export function buildGeminiBootstrapPrompt(): string {
  return [
    ...
    '- treat payload tools as available and callable for this runtime',
    '- do not claim tools are unavailable when tools are provided',
    '- local coding and workspace file operations in this runtime are authorized',
